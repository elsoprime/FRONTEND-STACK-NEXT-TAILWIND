            ...
            <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
              <div className="space-y-12">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400">
                    Autenticación multifactor obligatoria, SSO empresarial (SAML/OIDC) y registros
                    de auditoría inmutables para cada acción.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400">
                    Genere informes listos para juntas directivas con un solo clic, visualizando
                    KPIs operativos y ROI de infraestructura en tiempo real.
                  </p>
                </div>
              </div>
