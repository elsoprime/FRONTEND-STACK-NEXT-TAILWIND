...
export default function InventoryStocktakesPage() {
  ...
  return (
    <TenantPageShell
      eyebrow="Inventory"
      title="Conteo"
      description="Gestiona conteos del inventario del tenant activo."
      breadcrumbItems={[
